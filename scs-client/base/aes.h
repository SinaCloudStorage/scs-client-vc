...
#if !defined(AFX_AES_H__B552C1A8_DF16_4609_A993_BDFEBC154DBB__INCLUDED_)
#define AFX_AES_H__B552C1A8_DF16_4609_A993_BDFEBC154DBB__INCLUDED_
...
public:
	...
	virtual ~CAES();
public:
	CAES(int keySize, unsigned char* keyBytes);
...
private:
	...
	inline unsigned char gfmultby02(unsigned char b)
	{
		if (b < 0x80)
...
#endif // !defined(AFX_AES_H__B552C1A8_DF16_4609_A993_BDFEBC154DBB__INCLUDED_)
